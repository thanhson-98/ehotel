...
<header class="main-header">
    ...
    <!-- Logo -->
    <a href="{{ route('hotel-management') }}" style="text-decoration: none !important;" class="logo">
        <!-- mini logo for sidebar mini 50x50 pixels -->
        <span class="logo-lg"><img style="height: 50px; background-color: #f8f8f8" src="{{ asset('img/square_logo.png') }}"> <b>eHotel</b> Admin</span>
    </a>
